...
def home():
    radar_chart_html, line_graph_html, ratings_number = create_charts()
    return render_template("home.html", radar_chart_html=radar_chart_html,line_graph_html=line_graph_html,ratings_number=ratings_number)
